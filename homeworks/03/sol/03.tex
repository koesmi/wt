...
Entsprechend dem Tipp zeigen wir, dass $(Y_n)_n$ gleichgradig integrierbar ist.
Um die gleichgradige Integrierbarkeit von $(Y_n)_n$ zu zeigen, reicht es nach Lemma 20 zu zeigen, dass $E[|Y_n|]<\infty$ \emph{noch zu zeigen} und dass $\lim_{\varepsilon\to0}\sup_{A:P(A)<\varepsilon}\sup_{n}E[|Y_n|\mathbbm{1}_A]=0$.
Da $X_n\leq Y_n\leq Z_n$ ist $|Y_n|\leq|X_n|+|Z_n|$ für alle $n$.
Wegen der Monotonie und Linearität des Erwartungswertes erhalten wir
\begin{align*}
  &\lim_{\varepsilon\to0}\sup_{A:P(A)<\varepsilon}\sup_{n}E[|Y_n|\mathbbm{1}_A]\\
  &\quad\leq\lim_{\varepsilon\to0}\sup_{A:P(A)<\varepsilon}\sup_{n}E[|X_n|+|Z_n|\mathbbm{1}_A]\\
  &\quad=\lim_{\varepsilon\to0}\sup_{A:P(A)<\varepsilon}\sup_{n}E[|X_n|\mathbbm{1}_A]
    +\lim_{\varepsilon\to0}\sup_{A:P(A)<\varepsilon}\sup_{n}E[|Z_n|\mathbbm{1}_A]\\
  &\quad=0
\end{align*}
denn $(X_n)_n$ und $(Z_n)_n$ sind nach Theorem 22 gleichgradig integrierbar.
