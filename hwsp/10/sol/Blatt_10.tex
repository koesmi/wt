...
Sei $k\in\mathbb{N}$ so, dass $T_k>\tau_n$, dann sind auch die $S^{\tau_i}$ Martingale.
...
\begin{align*}
  E[(H\cdot S)_\infty]
  &=\sum_{i=1}^nE_Q[h_i(S_\infty^{\tau_i}-S_\infty^{\tau_{i-1}})]\,.
    \intertext{Mit der Turmeigenschaft der bedingten Erwartung erhalten wir}
  &=\sum_{i=1}^nE\bigl[E[h_i(S_\infty^{\tau_i}-S_\infty^{\tau_{i-1}})\mid\mathscr{F}_{\tau_{i-1}}]\bigr]\,.
    \intertext{Da die $h_i$ jeweils $\mathscr{F}_{\tau_{i-1}}$-messbar sind, folgt}
  &=\sum_{i=1}^nE\bigl[h_iE[S_\infty^{\tau_i}-S_\infty^{\tau_{i-1}}\mid\mathscr{F}_{\tau_{i-1}}]\bigr]\,.
    \intertext{Da $S$ ein Martingal ist, erhalten wir}
  &=\sum_{i=1}^nE\bigl[h_i(S_{\tau_{i-1}}^{\tau_i}-S_{\tau_{i-1}}^{\tau_{i-1}})\bigr]=0\,.
\end{align*}
